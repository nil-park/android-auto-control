...
| `adb`    | 폰을 USB로 붙이고 연결 상태를 확인한다                      | `adb version`      | <https://developer.android.com/tools/releases/platform-tools> |
...
`adb`는 platform-tools를 받아 PATH에 넣는다. [adb 설치](install-adb.md)를 따른다.
